...
class CategoryArchiveLabelListWidget extends WP_Widget {
    ...
    public function form( $instance ) {
        ...
        if ( isset($data['callw_type']) ) {
            $option_array[$data['callw_type']] = 'selected="selected"';
        }
        if ( isset($data['callw_period']) ) {
        ...
        <div class="callw-widget-options"><br>
            <div class="form-line">
                ...
                <div class="form-field">
                    <input class="widefat" id="<?php echo $this->get_field_id( 'callw_title' ); ?>" name="<?php echo $this->get_field_name( 'callw_title' ); ?>" type="text" value="<?php echo (isset($data['callw_title']) ? esc_attr( $data['callw_title'] ) : ''); ?>" />
                </div>
            </div>
    		<div class="form-line">
                <div class="form-label">
                ...
                <div class="form-field">
                    <select id="<?php echo $this->get_field_id( 'callw_type' ); ?>" class="callw-posts-type" name="<?php echo $this->get_field_name( 'callw_type' ); ?>">
        				<option value="archive" <?php echo (isset($option_array['archive']) ? $option_array['archive'] : ''); ?>><?php _e( 'Archive', 'category-archive-label-list-widget' ); ?></option>
        				<option value="categories" <?php echo (isset($option_array['categories']) ? $option_array['categories'] : ''); ?>><?php _e( 'Categories', 'category-archive-label-list-widget' ); ?></option>
            ...
            <div class="form-line archive-options">
                ...
                <div class="form-field">
                    <select id="<?php echo $this->get_field_id( 'callw_period' ); ?>" name="<?php echo $this->get_field_name( 'callw_period' ); ?>">
        				<option value="daily" <?php echo (isset($option_array['daily']) ? $option_array['daily'] : ''); ?>><?php _e( 'Daily', 'category-archive-label-list-widget' ); ?></option>
        				<option value="monthly" <?php echo (isset($option_array['monthly']) ? $option_array['monthly'] : ''); ?>><?php _e( 'Monthly', 'category-archive-label-list-widget' ); ?></option>
        				<option value="yearly" <?php echo (isset($option_array['yearly']) ? $option_array['yearly'] : ''); ?>><?php _e( 'Yearly', 'category-archive-label-list-widget' ); ?></option>
        			</select>
                </div>
            </div>
            ...
            <div class="form-line">
                ...
                <div class="form-field">
                    <input id="<?php echo $this->get_field_id( 'callw_lines' ); ?>" class="field-sm" name="<?php echo $this->get_field_name( 'callw_lines' ); ?>" type="text" value="<?php echo (isset($data['callw_lines']) ? esc_attr( $data['callw_lines'] ) : ''); ?>" size="3" />
                </div>
            </div>
            ...
            <div class="styling-options">
                <div class="form-line">
                    ...
                    <div class="form-field">
                        <input id="<?php echo $this->get_field_id( 'callw_styling_title_size' ); ?>" class="field-sm" name="<?php echo $this->get_field_name( 'callw_styling_title_size' ); ?>" type="text" value="<?php echo (isset($data['callw_styling_title_size']) ? esc_attr( $data['callw_styling_title_size'] ) : ''); ?>" size="3" />
                    </div>
                </div>
                ...
                <div class="form-line margin-bottom">
                    ...
                    <div class="form-field">
                        <input id="<?php echo $this->get_field_id( 'callw_styling_title_color' ); ?>" name="<?php echo $this->get_field_name( 'callw_styling_title_color' ); ?>" type="text" value="<?php echo (isset($data['callw_styling_title_color']) ? esc_attr( $data['callw_styling_title_color'] ) : ''); ?>" class="my-color-field" />
                    </div>
                </div>
                ...
                <div class="form-line">
                    ...
                    <div class="form-field">
                        <input id="<?php echo $this->get_field_id( 'callw_styling_links_size' ); ?>" class="field-sm" name="<?php echo $this->get_field_name( 'callw_styling_links_size' ); ?>" type="text" value="<?php echo (isset($data['callw_styling_links_size']) ? esc_attr( $data['callw_styling_links_size'] ) : ''); ?>" size="3" />
                    </div>
                </div>
                ...
                <div class="form-line margin-bottom">
                    ...
                    <div class="form-field">
                        <input id="<?php echo $this->get_field_id( 'callw_styling_links_color' ); ?>" name="<?php echo $this->get_field_name( 'callw_styling_links_color' ); ?>" type="text" value="<?php echo (isset($data['callw_styling_links_color']) ? esc_attr( $data['callw_styling_links_color'] ) : ''); ?>" class="my-color-field" />
                    </div>
                </div>
                ...
                <div class="form-line">
                    ...
                    <div class="form-field">
                        <input id="<?php echo $this->get_field_id( 'callw_styling_label_size' ); ?>" class="field-sm" name="<?php echo $this->get_field_name( 'callw_styling_label_size' ); ?>" type="text" value="<?php echo (isset($data['callw_styling_label_size']) ? esc_attr( $data['callw_styling_label_size'] ) : ''); ?>" size="3" />
                    </div>
                </div>
                ...
                <div class="form-line">
                    ...
                    <div class="form-field">
                        <input id="<?php echo $this->get_field_id( 'callw_styling_label_color' ); ?>" name="<?php echo $this->get_field_name( 'callw_styling_label_color' ); ?>" type="text" value="<?php echo (isset($data['callw_styling_label_color']) ? esc_attr( $data['callw_styling_label_color'] ) : ''); ?>" class="my-color-field" />
                    </div>
                </div>
                ...
                <div class="form-line">
                    ...
                    <div class="form-field">
                        <input id="<?php echo $this->get_field_id( 'callw_styling_label_bg_color' ); ?>" name="<?php echo $this->get_field_name( 'callw_styling_label_bg_color' ); ?>" type="text" value="<?php echo (isset($data['callw_styling_label_bg_color']) ? esc_attr( $data['callw_styling_label_bg_color'] ) : ''); ?>" class="my-color-field" />
                    </div>
                </div>
                ...
                <div class="form-line">
                    ...
                    <div class="form-field">
                        <textarea id="<?php echo $this->get_field_id( 'callw_styling_custom_css' ); ?>" name="<?php echo $this->get_field_name( 'callw_styling_custom_css' ); ?>" rows="5"><?php echo (isset($data['callw_styling_custom_css']) ? esc_attr( $data['callw_styling_custom_css'] ) : ''); ?></textarea>
                    </div>
                </div>
            </div>
        </div><br><br>
...
add_action('plugins_loaded', 'callw_load_textdomain');
function callw_load_textdomain() {
	load_plugin_textdomain( 'category-archive-label-list-widget', false, dirname( plugin_basename(__FILE__) ) . '/lang/' );
}
